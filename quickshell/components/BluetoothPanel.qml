            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        height: 24
                        radius: 6
                        color: btDiscoverBtnMa.containsMouse ? Qt.rgba(root.walColor2.r, root.walColor2.g, root.walColor2.b, 0.2) : Qt.rgba(0, 0, 0, 0.3)
                        Text {
                            anchors.centerIn: parent
                            text: "Discoverable"
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            cursorShape: Qt.PointingHandCursor
                            onClicked: root.enableBtDiscoverable()
                        }
                    }
                    Rectangle {
                        width: 60
